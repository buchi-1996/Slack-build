    ...
    return (
        <header className="flex flex-row items-center justify-between bg-dark-purple pr-4 py-1.5 border-b border-light-purple">
            ...
            <div className="flex-1 flex flex-row items-center bg-light-purple relative rounded px-2 py-0.5">
                <input type="text" className="flex-1  rounded focus:outline-none bg-transparent text-sm placeholder-white text-white font-medium" placeholder="Search Hiltop Web Solutions" />
                <span className="pl-1">
            ...
            <div className="flex flex-row items-center justify-between space-x-8 md:w-1/3.5 pl-5">
                ...
                <button className="relative flex-none">
                    <img src="./assets/slack-avatar.png" alt="" className="rounded object-contain w-7 h-auto flex-none"/>
